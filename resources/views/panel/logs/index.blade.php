@extends('panel.base')
@section('title', __('logs.logs'))

@section('breadcrumb_link')
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{route('admin.index')}}">@lang('dashboard.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('logs.logs')</li>
    </ol>
@endsection
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">@lang('logs.logs')</h3>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="logs_table" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>@lang('logs.old_data')</th>
                        <th>@lang('logs.new_data')</th>
    ...
    <script>
        $(document).ready(function () {
            $('#logs_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{route('admin.system-logs.data')}}',
                    method: 'POST',
                    data: {
                        _token: '{{csrf_token()}}'
                    }
                ...
                columns: [
                    ...
                    { data: 'old_data', name: 'old_data', orderable: false },
                    { data: 'new_data', name: 'new_data', orderable: false },
                ...
                drawCallback: function () {
                    $('.dtr-bs-modal').find('.modal-dialog').addClass('modal-xl');
                }
            });
